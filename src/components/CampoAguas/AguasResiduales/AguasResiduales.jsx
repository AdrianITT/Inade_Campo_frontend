...
const columns = useMemo(
  () => [
    ...
    },
    {
      ...
      filters: ordenes.map(({ OTcodigo }) => ({ text: OTcodigo, value: OTcodigo })),
      filterSearch: true,
    ...
    },
    {
      ...
      filters: ordenes.map(({contacto})=>({text: contacto, value:contacto})),
      filterSearch:true,
    ...
    },
    {
      ...
      filters: ordenes.map(({receptor})=> ({text: receptor, value: receptor})),
      filterSearch:true,
    },
    {
      title: "Empresa",
      ...
      filters: ordenes.map(({nombreEmpresa})=> ({text: nombreEmpresa, value: nombreEmpresa})),
      filterSearch:true,
    },
    {
      title: "Dirección",
