//llenar_excel_con_informacion2/<int:custodia_id>/
import { Api_Host } from "../Api";

export const getPDFCustodiaExterna = (id) => Api_Host.get(`/campo/llenar_excel_con_informacion2/${id}/`, { responseType: "blob" });
